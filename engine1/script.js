...
jQuery(".wowslider-container-listview").each(function(){
    jQuery(this).wowSlider({effect:"basic",prev:"",next:"",duration:20*100,delay:20*100,width:260,height:195,autoPlay:false,playPause:false,stopOnHover:false,loop:false,bullets:0,caption:false,captionEffect:"slide",controls:true,onBeforeStep:0,images:0});
});
