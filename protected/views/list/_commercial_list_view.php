...
<div class="row-fluid" style="margin-top: 15px;">
    <div class="span12 <?php echo $propertyBoxClass; ?>">
        <div class="heading_commercial" id="box-heading"  style="background-color: <?php echo $backgroundColor; ?>; font-weight: <?php echo $bold; ?>">
            <div class="span8">
                <?php
                $address = "";
        ...
        <div class="row-fluid span12" style="margin-left: 0">
            <div class="span6" style="padding-top: 0;border-right: solid 1px silver; position: relative; top:0; left: 0; width: auto; max-height: 275px; ">
                <?php
                                    ...
                                    if (count($data->propertyimages) > 0) {
                                        ...
                                        foreach ($data->propertyimages as $value) {
                                            ...
                                            if ($value->imagetype == 0) {
                                                ...
                                                if ($imgname != "") {?>
                                                    <li>
                                                        <img src="<?php echo Yii::app()->baseUrl . '/upload/propertyimages/' . $imgname ?>" style="max-height: 220px;">
                                                    </li>

                                                <?php
                                                } else{ ?>
                                                    <li>
                                                        <img src="<?php echo Yii::app()->baseUrl . '/upload/propertyimages/' . $data->propertyimages[0]->imagename ?>" style="max-height: 220px;">
                                                    </li>
                                                <?php
                                                }
                                            }
                                        ...
                                        <li>
                                            <img src="<?php echo Yii::app()->baseUrl;?> . /upload/propertyimages/prop_no_img.jpg" style="max-height: 220px;">
                                        </li>
                                    <?php } ?>
                                </ul>
                            </div>
