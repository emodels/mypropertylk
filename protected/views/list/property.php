...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        if (<?php echo $_GET['type']; ?> == buy) {
            ...
            document.getElementById('box-heading').style.backgroundColor = '#660099';
        ...
        if (<?php echo $_GET['type']?> == rent) {
            ...
            document.getElementById('box-heading').style.backgroundColor = '#009900';
        }

        if (<?php echo $_GET['type']?> == sold) {
            $('#menu-primary-menu li').removeClass('current_page_item');
            $('#menu-primary-menu li#sold').addClass('current_page_item');
            document.getElementById('box-heading').style.backgroundColor = '#CC0000';
        }
                ...
                <div class="span3">
                    <div class="row-fluid">
                        ...
                        <div class="span12">
                            ...
                            <div class="span11 input-append" style="margin-left: 0;">
                        ...
                        <div class="span12">
                            ...
                            <div class="span11"  style="margin-left: 0;">
                                <?php echo $form->textField($model,'landsize', array('placeholder'=>'Min Size', 'class' => 'span10')); ?>
                            </div>
                        </div>
                        <div class="span12">
                            <div class="span6">
                        ...
                        <div class="span12" style="padding-top: 10px;">
                            ...
                            <div class="span11"  style="margin-left: 0;">
                                <?php echo $form->textField($model,'landsize', array('placeholder'=>'e.g. investment', 'class' => 'span10')); ?>
                            </div>
                        </div>
                        <div class="span12" style="padding-top: 10px;">
                                <label>New or Established</label>
                                <div class="btn-group">
                                    <button class="btn" style="width: 150px;">Any</button>
                                    <button class="btn dropdown-toggle" data-toggle="dropdown">
                                        <span class="caret"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                        ...
                        <div calss="hidden-phone hidden-tablet ads_placeholder_large span6"  style="padding-top: 20px;">
