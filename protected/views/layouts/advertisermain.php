    ...
    <header id="header" role="banner">
        <div class="admin-banner">
            <div class="container admin-controls">
                <div class="span4">
                    <div class="logo">Advertiser Control</div>
                </div>
                ...
                <div class="span2 col_left_bg">
                    ...
                    <div class="col_left">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a id="admin_home" href="<?php echo Yii::app()->request->baseUrl; ?>/advertiser/home" class="active"><i class="icon-home icon_gap"></i>Home</a></li>
