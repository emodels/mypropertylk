        ...
        <div class="container-fluid" style="padding: 0;">
            ...
            <div class="control-group-admin">
                ...
                <?php if (!empty($model->background_image)) { ?>
                    <img src="<?php echo Yii::app()->baseUrl ?>/upload/landingpageimages/<?php echo $model->background_image; ?>" width="200px"/>
                    <input type="checkbox" id="chkRemoveImage" name="chkRemoveImage" style="margin-left: 50px"/> Delete Page Content - Image
                <?php } ?>
            </div>
            <div class="control-group-admin">
