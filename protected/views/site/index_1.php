...
<script type='text/javascript' src='<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.bxslider.min.js'></script>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $('#ikman_map area').click(function (event) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo Yii::app()->request->baseUrl; ?>/list/searchjson/district/' + district,
                beforeSend: function(){
                    $('#div_citylist img').css('display','block');
                },
                success: function(data){
                    data.forEach(function (element){
                        $('#citylist').append($('<option></option>').val(element).html(element));
                    });
                    $('#div_citylist img').css('display','none');
...
<div class="content-wrapper clearfix">
    ...
    <div id="headline_wrapper" class="imgslider">
<ul class="bxslider">
    <li><img src="images/colombo-1.jpg" title="image_1" width="1349px" height="400px"/></li>
    <li><img src="images/colombo-2.jpg" title="image_2" width="1349px" height="400px"/></li>
    <li><img src="images/colombo-3.jpg" title="image_3" width="1349px" height="400px"/></li>
    <li><img src="images/colombo-4.jpg" title="image_4" width="1349px"height="400px"/></li>
</ul>
    </div> 
        ...
        <div id="headline_container" class="container">
            ...
            <!--    <div id="div_citylist" style="position: absolute; top: 20px; right: 10px; z-index: 101; display: none">
                    <label><strong>Select Suburb or Region</strong></label>
  ...
  <!--  <div id="headline_wrapper" class="imgslider">
        <ul class="bxslider">
  <li><img src="http://40.media.tumblr.com/tumblr_lsrcc3uAxK1qdfjizo1_1280.jpg" title="" /></li>
  <li><img src="http://nation.lk/online/wp-content/uploads/2015/05/luxury-paradise-640x400.jpg" title="" /></li>
  <li><img src="http://40.media.tumblr.com/tumblr_lsrcc3uAxK1qdfjizo1_1280.jpg" title="" /></li>
  <li><img src="http://40.media.tumblr.com/tumblr_lsrcc3uAxK1qdfjizo1_1280.jpg" title="" /></li>
</ul>
    </div> -->
            ...
            <div class="span12">
                <div class="row-fluid">
                    ...
                    <div class="span3 hidden-phone">
                        <?php
                        $condition = '(t.page = 1 AND (t.size = 2 OR t.size = 4 OR t.size = 6) AND t.status = 1) AND t.expiredate >= CURDATE()';
