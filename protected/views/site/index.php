                                ...
                                <div class="form">
                                    ...
                                    <div class="span12">
                                        <div class="span10 input-append">
                                            <?php echo $form->textField($model,'townname', array('placeholder'=>'e.g: Colombo; Colombo 08 ; Borella', 'class' => 'span11', 'id' => 'appendedDropdownButton')); ?>
                                            <div class="btn-group">
                        ...
                        <article class="property-item">
                            <div class="property-images">
                                <a href="<?php echo Yii::app()->baseUrl . '/list/detail?pid=' .$data->pid;?>" title="<?php echo $data->pid; ?>">
                                    <img width="540" height="360" src="<?php echo Yii::app()->baseUrl . '/upload/propertyimages/'. ((count($data->propertyimages) > 0) ? $data->propertyimages[0]->imagename : 'prop_no_img.jpg') ?>" class="status-35 wp-post-image" alt="<?php echo $data->pid; ?>" title="<?php echo $data->pid; ?>" /></a>
                                <div>
                                    <?php
