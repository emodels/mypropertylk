                ...
                <div>
                    <div class="span8">
                        <div class="form_bg">
                            ...
                            <div class="control-group-admin">
                                <?php echo $form->textField($model,'toilets', array('placeholder'=>'Toilets', 'value'=>'')); ?>
                            </div>
                            <div class="control-group-admin">
                                <?php echo $form->textField($model,'parkgaragespaces', array('placeholder'=>'Parking - Garage Spaces', 'value'=>'')); ?>
                            </div>
                            <div class="control-group-admin">
                                <?php echo $form->textField($model,'parkcarpetspaces', array('placeholder'=>'Parking - Carpet Spaces', 'value'=>'')); ?>
                            </div>
                            <div class="control-group-admin">
                                <?php echo $form->textField($model,'parkopenspaces', array('placeholder'=>'Parking - Open Spaces', 'value'=>'')); ?>
                            ...
                            <div class="control-group-admin">
                                <?php echo $form->textField($model,'livingarea', array('placeholder'=>'Living Areas', 'value'=>'')); ?>
                            </div>
                            <div class="control-group-admin">
                            ...
                            <?php if ($model->type == 4 || $model->type == 5){  ?>
                                ...
                                <div class="control-group-admin">
                                    <?php echo $form->textField($model,'building', array('placeholder'=>'Building', 'value'=>'')); ?>
                                </div>
                                <div class="control-group-admin">
                                    <?php
                                ...
                                <div class="control-group-admin">
                                    <?php echo $form->textField($model,'parkcomment', array('placeholder'=>'Parking Comments', 'value'=>'')); ?>
                                </div>
                                <div class="control-group-admin">
                                    <?php echo $form->textField($model,'zoning', array('placeholder'=>'Zoning', 'value'=>'')); ?>
                                </div>
                            <?php } ?>
                            ...
                            <?php if ($model->type == 5){  ?>
                            <div class="control-group-admin">
                                <?php echo $form->textField($model,'outgoings', array('placeholder'=>'Outgoings', 'value'=>'')); ?>
                            </div>
                            <?php } ?>
                            <!---------( End Commercial Leased )------------------>
                            <!---------( For Home Sales & Home Rentals )------------------>
