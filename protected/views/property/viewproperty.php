...
<div class="col_right" style="padding-top: 0;">
    <div class="span12" style="border-bottom: solid 1px silver; padding-top: 20px; font-size: 12px; color: #999999;">
            <div class="span6">
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/property/propertylisting?type=0" style="color: #999999; text-decoration: none;">
    ...
    <div class="span12" style="margin-top: 15px; background: -webkit-linear-gradient(#0088cc, #ffffff); /* For Safari 5.1 to 6.0 */
                                                 background: -o-linear-gradient(#0088cc, #ffffff); /* For Opera 11.1 to 12.0 */
                                                 background: -moz-linear-gradient(#0088cc, #ffffff); /* For Firefox 3.6 to 15 */
                                                 background: linear-gradient(#0088cc, #ffffff); /* Standard syntax */ margin-left: 0">

        <div class="row-fluid span12" style="margin: 10px 0 0 0; color: #ffffff">
        ...
        <div class="span12">
            <div class="span12" style="margin-left: 12px; margin-bottom: 15px">
    ...
    <div class="span12" style="margin-left: 0; margin-bottom: 10px">
        <div class="span8" style="margin-top: 10px; margin-left: 0; padding: 10px 0;">
            ...
            <div class="span12" style="border-top: solid 1px silver; border-bottom: solid 1px silver; padding-top: 10px; margin-left: 0;">
                <div class="span6">
            ...
            <div class="span12" style="padding-top: 10px; margin-left: 0;">
                <div class="span6">
        ...
        <div class="row-fluid span4" style="margin-top: 20px;" >
            <div>
            ...
            <div style="padding-top: 20px;">
                <div style="border: solid 1px silver; width: 98%; height: 100%;">
