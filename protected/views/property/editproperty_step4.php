...
<div class="col_right" style="padding-top: 0;">
    ...
    <div class="edit-header">
        ...
        <img class="listing-background-image" src="<?php echo Yii::app()->request->baseUrl.'/upload/propertyimages/'.((count($model->property0->propertyimages) > 0) ? $model->property0->propertyimages[0]->imagename : 'prop_no_img.jpg') ?>">
    </div>
