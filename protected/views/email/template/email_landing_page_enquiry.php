    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td style="padding-top: 15px;">
                <p>
                    You have received a new Landing Page Enquiry <a href="http://www.myproperty.lk">myproperty.lk</a> for:
                </p>
            </td>
        </tr>
        <tr>
...
<div style="position: relative; padding: 20px; margin-left: 10px; border: solid 1px silver; background: #f7f7f7; border-radius: 10px; font-size: 15px; width: 80%">
    <table border="0" cellpadding="2" cellspacing="2" width="100%">
        ...
        <tr>
            <td style="width: 200px"><b>Post code</b></td>
        ...
        <tr>
            <td style="width: 200px"><b>Best Time to Contact</b></td>
            <td><?php echo $model['best_time']; ?></td>
        </tr>
    </table>
</div>
</body>
