...
<div class="col_right" style="padding-top: 0;">
    <div>
        <h3 style="margin-top: 0; border-bottom: solid 1px silver">Edit Home Ideas</h3>
    </div>
            ...
            <div class="span12">
                ...
                <div class="form_bg control-group-admin">
                    <div class="control-group">
                        ...
                        <?php echo $form->fileField($model, 'imagename',array(),array('tabindex'=>13));
                        if(isset($model->imagename))
                        {
                            echo CHtml::image(Yii::app()->controller->createUrl('upload/homeideasimages/'.$model->imagename), "No Image",array('style'=>'width:150pxs; height:100px; border:solid 1px silver;'));
                        }
                        ?>
                    </div>
            ...
            <div class="span8" style="padding-bottom: 10px;">
                <div class="control-group-admin-btn">
                    <div class="span12" style="padding-top: 5px;">
                        <?php echo CHtml::submitButton('Edit Home Ideas', array('class' => 'btn btn-primary')); ?>
                        &nbsp;
                        <?php
                        $url = "";
