...
class EditPropertyAction_Step2 extends CAction
{
    /*
    ...
    public function run()
    {
        if (isset(Yii::app()->session['property_id'])) {
            ...
            if (isset($model)) {
                ...
                if (isset($_POST['Property'])) {
                    ...
                    if ($model->save(false)){
                        $this->getController()->redirect(Yii::app()->baseUrl . '/property/editproperty_step3');
                    } else{
        ...
        $this->getController()->render('editproperty_step2', array('model'=>$model));
    }
}