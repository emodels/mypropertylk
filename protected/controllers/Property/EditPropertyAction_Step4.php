...
class EditPropertyAction_Step4 extends CAction
{
    /*
    ...
    public function run()
    {
        ...
        if (isset(Yii::app()->session['property_id'])) {
            ...
            if (isset($property)) {
                ...
                if (Yii::app()->request->isPostRequest && !Yii::app()->request->isAjaxRequest) {
                    ...
                    Yii::app()->user->setFlash('success', 'Property Updated Successfully');
        ...
        $this->getController()->render('editproperty_step4', array('model'=>$model));
    }
}